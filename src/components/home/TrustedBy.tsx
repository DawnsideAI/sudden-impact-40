    ...
    <div className="py-16 bg-[#0C0F19] rounded-3xl mx-4 md:mx-8">
      ...
      >
        {logos.map((logo, index) => (
          ...
          >
            <div className="h-16 w-16 flex items-center justify-center mb-3 bg-[#131626] rounded-full p-4 shadow-lg">
              {logo.name === 'Github' && logo.component && (
                <logo.component className="h-12 w-12 text-white" />
              )}
              {logo.name === 'Chrome' && (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-9 w-9 fill-current text-blue-500">
              ...
              {logo.name === 'Slack' && (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-9 w-9 fill-current text-pink-500">
              ...
              {logo.name === 'Figma' && (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-9 w-9 fill-current text-purple-500">
                  <path d="M8.5 2a3.5 3.5 0 100 7h7a3.5 3.5 0 100-7h-7zm7 7h-7a3.5 3.5 0 000 7h1.5v-3.5H15a3.5 3.5 0 100-3.5zm-5.5 7v3.5a3.5 3.5 0 107 0v-3.5h-7z" fillRule="evenodd" clipRule="evenodd" />
                  <path d="M8.5 16a3.5 3.5 0 117 0 3.5 3.5 0 01-7 0z" />
                  <path d="M8.5 2h7a3.5 3.5 0 010 7h-7V2z" />
                </svg>
              )}
              {logo.name === 'Dribbble' && (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-9 w-9 fill-current text-pink-600">
            ...
            <span className={`${logo.color} font-semibold text-lg`}>{logo.name}</span>
          </motion.div>
        ))}
      </StyleProvider>
    </div>
