  ...
  return (
    <div className="relative overflow-hidden bg-white border-b border-gray-200">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute h-[600px] w-[600px] rounded-full bg-brand-violet/5 blur-3xl -top-20 -left-20"></div>
        <div className="absolute h-[700px] w-[700px] rounded-full bg-brand-indigo/5 blur-3xl top-40 right-10"></div>
      </div>
